          ...
          <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
            <main>
              ...
              <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                <h3 class="text-primary text-lg font-bold mb-6">Job Description</h3>
            ...
            <aside>
              <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="my-2 bg-blue-100 p-2 font-bold">{{ state.job.company.contactEmail }}</p>
              ...
              <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                <RouterLink :to="`/jobs/edit/${state.job.id}`" class="bg-primary hover:bg-highlight text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block">Edit Job</RouterLink>
